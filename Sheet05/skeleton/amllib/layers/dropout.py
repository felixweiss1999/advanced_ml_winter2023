...
class Dropout(Layer):
    ...
    def __call__(self, input: np.ndarray) -> np.ndarray:
        ...
        """
        # TODO Implement the evaluation of the dropout layer
        # when the layer is called outside of training.
        # Caution: the code in the lecture _keeps_ neurons,
        # we want to _drop_ neurons.
        pass
    ...
    def feedforward(self, input: np.ndarray) -> np.ndarray:
        ...
        # TODO Implement the evaluation of the dropout layer while
        # training. Use self.mask to store a mask of the randomly dropped
        # neurons, and apply it to the input.
        # Use numpy.random.binomial to obtain the mask.
        # Generate the same mask for the whole minibatch,
        # which can be achieved by using `shape` as mask shape.
    ...
    def backprop(self, delta: np.ndarray) -> np.ndarray:
        ...
        # TODO Implement the backpropagation of a dropout layer.
        # For backpropagation think about the derivative of the
        # feedforward evaluation of the layer.
        pass
