...
class Adam(Optimizer):
    ...
    def update(self, data: list[np.ndarray], ddata: list[np.ndarray]) -> None:
        ...
        # TODO Implement the Adam method. The list v
        # contains the first moments from the last
        # computation step and the list w contains
        # the second moments (See lecture notes, section 2.5.7).
        # They should be overwritten by the new first
        # and second moments.
