"""Test for our implementation of a 2D convolutional layer with FFT."""
...
class TestConv2D(unittest.TestCase):
    ...
    def test_backprop(self):
        ...
        assert_array_almost_equal(delta_conv, delta_result, 13, err_msg='The result of the Conv2D backpropagation '
