...
class AveragePool2D(Layer):
    ...
    def __init__(self, area: tuple[int, int], strict: bool = False):
        ...
        self.area = area
        self.shape = None
        self.mask = None # Nicht gebraucht?
        self.strict = strict # Nicht gebraucht?
    ...
    def backprop(self, delta: np.ndarray) -> np.ndarray:
        ...
        da_reshaped, _ = np.broadcast_arrays(delta_newaxis, da_reshaped)
        # Multiply with derivative of the average
        da_reshaped /= ph * pw
